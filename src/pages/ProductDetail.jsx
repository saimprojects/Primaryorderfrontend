    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-50 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:bg-green-600 transition-all duration-300 transform hover:scale-110 animate-bounce"
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-xs sm:text-sm md:text-base">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2">
                            ...
                            <span className="font-mono font-bold bg-black/20 px-2 py-1 rounded text-xs sm:text-sm">
            ...
            <div className="container mx-auto px-4 py-3">
                <nav className="flex items-center space-x-1 sm:space-x-2 text-xs sm:text-sm text-gray-600 overflow-x-auto">
                    <Link to="/" className="hover:text-[#FF5C00] transition-colors whitespace-nowrap">Home</Link>
                    <FaChevronRight className="text-xs" />
                    <Link to="/categories" className="hover:text-[#FF5C00] transition-colors whitespace-nowrap">Categories</Link>
                    <FaChevronRight className="text-xs" />
                    {product.category_name && (
                        <>
                            <Link 
                                to={`/category/${product.category_slug}`}
                                className="hover:text-[#FF5C00] transition-colors whitespace-nowrap"
                            >
                                {product.category_name}
                            </Link>
                            <FaChevronRight className="text-xs" />
                    ...
                    <span className="text-gray-800 font-medium truncate whitespace-nowrap">{product.title}</span>
                </nav>
            </div>
            ...
            <div className="container mx-auto px-4 py-4 sm:py-6">
                <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 xl:gap-12">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                        {/* Main Image */}
                        <div className="relative bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl overflow-hidden group">
                            <img
                                src={images[activeImageIndex]?.image_url || images[activeImageIndex]?.image?.url}
                                alt={product.title}
                                className="w-full h-[300px] sm:h-[400px] md:h-[500px] object-contain p-4 sm:p-8"
                            />
                            ...
                            {images.length > 1 && (
                                <>
                                    <button
                                        ...
                                        className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                                    >
                                        <FaChevronLeft className="text-sm sm:text-base" />
                                    </button>
                                    <button
                                        onClick={() => setActiveImageIndex(prev => prev === images.length - 1 ? 0 : prev + 1)}
                                        className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-white/90 hover:bg-white w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                                    >
                            ...
                            <div className="absolute top-2 sm:top-4 left-2 sm:left-4 space-y-1 sm:space-y-2">
                                {discountPercentage > 0 && (
                                    <div className="bg-red-600 text-white px-2 sm:px-4 py-1 sm:py-2 rounded-full font-bold text-sm sm:text-lg shadow-xl animate-pulse">
                                        {discountPercentage}% OFF
                                    </div>
                                )}
                                {stockLeft <= 10 && stockLeft > 0 && (
                                    <div className="bg-orange-500 text-white px-2 sm:px-4 py-1 sm:py-2 rounded-full font-bold text-sm sm:text-lg flex items-center gap-1 sm:gap-2">
                                        <FaFire className="text-xs sm:text-sm" /> 
                                        <span className="text-xs sm:text-sm">Only {stockLeft} left!</span>
                                    </div>
                                )}
                                {/* 🔥 UPDATED: Variant Badge */}
                                {selectedVariant && (
                                    <div className="bg-blue-600 text-white px-2 sm:px-3 py-1 rounded-full font-bold text-xs sm:text-sm flex items-center gap-1">
                                        <FaLayerGroup className="text-xs" /> 
                                        <span className="text-xs sm:text-sm">{selectedVariant.sku}</span>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="absolute top-2 sm:top-4 right-2 sm:right-4 space-y-1 sm:space-y-2">
                                <button
                                    ...
                                    className="bg-white/90 hover:bg-white w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center"
                                >
                                    {wishlisted ? (
                                        <FaHeart className="text-red-500 text-sm sm:text-base md:text-xl" />
                                    ) : (
                                        <FaRegHeart className="text-gray-600 text-sm sm:text-base md:text-xl" />
                                    )}
                                </button>
                                <button
                                    ...
                                    className="bg-white/90 hover:bg-white w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center"
                                >
                                    <FaShareAlt className="text-gray-600 text-sm sm:text-base md:text-xl" />
                                </button>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-4 sm:grid-cols-5 gap-2 sm:gap-3">
                                {images.map((img, index) => (
                                    <button
                                        ...
                                        className={`relative rounded-lg sm:rounded-xl overflow-hidden border-2 sm:border-4 transition-all ${
                                            activeImageIndex === index
                                                ? "border-[#FF5C00] shadow-md sm:shadow-lg"
                    ...
                    <div className="space-y-4 sm:space-y-6">
                        <div>
                            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 sm:mb-3">
                                {product.title}
                                {selectedVariant && (
                                    <span className="text-sm sm:text-base md:text-lg text-gray-600 ml-2 font-normal block sm:inline">
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-4">
                                <div className="flex items-center gap-2 bg-blue-50 px-3 py-1 rounded-full w-fit">
                                    ...
                                    <span className="text-gray-600 hidden sm:inline">({product.review_count || 0} reviews)</span>
                                </div>
                            ...
                            {product.has_variants && (
                                <div className="bg-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 border border-gray-200">
                                    <div className="flex justify-between items-center mb-3 sm:mb-4">
                                        <h3 className="font-bold text-gray-800 text-base sm:text-lg">Select Options:</h3>
                                        {(selectedSize || selectedColor || selectedMaterial) && (
                                            <button
                                                onClick={resetFilters}
                                                className="text-xs sm:text-sm text-[#FF5C00] hover:text-[#E55100] font-medium"
                                            >
                                                Clear Filters
                                            </button>
                                        )}
                                    ...
                                    {allVariantsOutOfStock && (
                                        <div className="bg-red-50 border border-red-200 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                                            <div className="flex items-center gap-2 sm:gap-3">
                                                ...
                                                <div>
                                                    <div className="font-bold text-red-700 text-sm sm:text-base">All variants are out of stock</div>
                                                    <div className="text-xs sm:text-sm text-red-600">Please check back later</div>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {getAvailableSizes().length > 0 && (
                                        <div className="mb-3 sm:mb-4">
                                            <div className="flex items-center gap-2 mb-2 sm:mb-3">
                                                ...
                                                <label className="font-medium text-gray-700 text-sm sm:text-base">Size:</label>
                                            </div>
                                            <div className="flex flex-wrap gap-1 sm:gap-2">
                                                {getAvailableSizes().map((size) => (
                                                    <button
                                                        ...
                                                        className={`px-3 sm:px-4 py-1 sm:py-2 rounded-lg font-medium transition-all text-xs sm:text-sm ${
                                                            selectedSize === size
                                    ...
                                    {getAvailableColors().length > 0 && (
                                        <div className="mb-3 sm:mb-4">
                                            <div className="flex items-center gap-2 mb-2 sm:mb-3">
                                                ...
                                                <label className="font-medium text-gray-700 text-sm sm:text-base">Color:</label>
                                            </div>
                                            <div className="flex flex-wrap gap-2 sm:gap-3">
                                                {getAvailableColors().map((color) => (
                                                    <button
                                                        ...
                                                        className={`px-3 sm:px-4 py-1 sm:py-2 rounded-lg font-medium transition-all text-xs sm:text-sm flex items-center gap-1 sm:gap-2 ${
                                                            selectedColor === color
                                                                ? 'bg-[#FF5C00] text-white shadow-md'
                                                                : 'bg-white text-gray-700 border border-gray-300 hover:border-[#FF5C00]'
                                                        }`}
                                    ...
                                    {getAvailableMaterials().length > 0 && (
                                        <div className="mb-3 sm:mb-4">
                                            <div className="flex items-center gap-2 mb-2 sm:mb-3">
                                                ...
                                                <label className="font-medium text-gray-700 text-sm sm:text-base">Material:</label>
                                            </div>
                                            <div className="flex flex-wrap gap-1 sm:gap-2">
                                    ...
                                    {filteredVariants.length > 0 && (
                                        <div className="mt-3 sm:mt-4">
                                            <label className="font-medium text-gray-700 mb-2 block text-sm sm:text-base">Available Variants:</label>
                                            <div className="grid grid-cols-1 gap-1 sm:gap-2 max-h-32 sm:max-h-40 overflow-y-auto p-2">
                                                    ...
                                                    >
                                                        <div className="flex justify-between items-center">
                                                            <div>
                                                                ...
                                                                <div className={`text-xs ${variant.stock > 0 ? 'text-gray-600' : 'text-red-600'}`}>
                                    ...
                                    {filteredVariants.length === 0 && availableVariants.length > 0 && (
                                        <div className="mt-3 sm:mt-4 text-center py-3 sm:py-4 bg-gray-100 rounded-lg">
                                            <FaExclamationTriangle className="text-yellow-500 text-lg sm:text-xl mx-auto mb-1 sm:mb-2" />
                                            <p className="text-gray-600 text-xs sm:text-sm">No variants available with the selected options.</p>
                                            <button
                                                onClick={resetFilters}
                                                className="mt-1 sm:mt-2 text-[#FF5C00] hover:text-[#E55100] font-medium text-xs sm:text-sm"
                                            >
                            ...
                            {/* Seller Info */}
                            <div className="flex items-center gap-3 bg-gray-50 p-3 sm:p-4 rounded-xl mb-4 sm:mb-6">
                                ...
                                <div className="flex-1">
                                    <div className="font-bold text-sm sm:text-base">Sold by PrimaryOrder</div>
                                    <div className="text-xs sm:text-sm text-gray-600">Pakistan • 98% Positive Seller Rating</div>
                                </div>
                                <button className="text-[#FF5C00] font-bold hover:text-[#E55100] text-xs sm:text-sm">
                                    Visit Store
                                </button>
                            </div>
                        </div>
                        ...
                        {/* Price Section */}
                        <div className="bg-gradient-to-r from-gray-50 to-white p-4 sm:p-6 rounded-xl sm:rounded-2xl border-2 border-orange-100">
                            <div className="space-y-2">
                                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#1A1A1A]">
                                ...
                                {discountPercentage > 0 && (
                                    <div className="space-y-1">
                                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                            ...
                                            <span className="bg-red-100 text-red-700 px-2 sm:px-3 py-1 rounded-full font-bold text-sm sm:text-base w-fit">
                                                Save {formatPrice(savings)}!
                                            </span>
                                        </div>
                                        <div className="text-green-600 font-bold text-base sm:text-lg">
                                            <FaPercent className="inline mr-1 sm:mr-2" />
                        ...
                        {stockLeft > 0 && stockLeft <= 15 && (
                            <div className="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-3 sm:p-4 rounded-xl">
                        ...
                        {product.has_variants && !selectedVariant && (
                            <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-3 sm:p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-bold text-yellow-700 text-sm sm:text-base">Please select a variant</div>
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div>
                                <label className="block font-bold text-gray-700 mb-2 text-sm sm:text-base">Quantity:</label>
                                <div className="flex items-center gap-3 sm:gap-4">
                                    <div className="flex items-center border border-gray-300 rounded-xl overflow-hidden">
                                        <button
                                            onClick={() => setQuantity(prev => Math.max(1, prev - 1))}
                                            disabled={stockLeft === 0}
                                            className="px-3 sm:px-4 py-2 sm:py-3 bg-gray-100 hover:bg-gray-200 text-lg sm:text-xl font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            -
                                        </button>
                                        <span className="px-4 sm:px-6 py-2 sm:py-3 text-lg sm:text-xl font-bold min-w-[50px] sm:min-w-[60px] text-center">
                                            {quantity}
                                        </span>
                                        <button
                                    ...
                                    <div className={`text-xs sm:text-sm ${stockLeft === 0 ? 'text-red-600' : 'text-gray-600'}`}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                                <button
                                    ...
                                    className={`bg-gradient-to-r from-[#FF5C00] to-orange-500 text-white font-bold py-3 sm:py-4 rounded-xl text-base sm:text-lg hover:from-[#E55100] hover:to-orange-600 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center gap-2 sm:gap-3 ${
                                ...
                                <button
                                    ...
                                    className={`bg-gradient-to-r from-[#1A1A1A] to-gray-800 text-white font-bold py-3 sm:py-4 rounded-xl text-base sm:text-lg hover:from-gray-800 hover:to-gray-900 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center gap-2 sm:gap-3 ${
                        ...
                        {/* Trust Badges */}
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 pt-4 sm:pt-6 border-t">
                            {[
                                { icon: FaTruck, color: "green", title: "Free Delivery", desc: "Over PKR 2000" },
                                { icon: FaUndo, color: "blue", title: "7-Day Returns", desc: "Easy Returns" },
                                { icon: FaShieldAlt, color: "purple", title: "Warranty", desc: "Varies by product" },
                                { icon: FaBoxOpen, color: "orange", title: "Cash on Delivery", desc: "Available" }
                            ].map((item, index) => (
                                <div key={index} className="text-center p-2 sm:p-3 bg-gray-50 rounded-xl">
                                    <item.icon className={`text-${item.color}-600 text-xl sm:text-2xl mx-auto mb-1 sm:mb-2`} />
                ...
                {/* Description & Details */}
                <div className="mt-8 sm:mt-12 md:mt-16 grid md:grid-cols-3 gap-6 sm:gap-8">
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 gap-4">
                                ...
                                <button 
                                    ...
                                    className="bg-[#FF5C00] text-white px-4 sm:px-6 py-2 rounded-lg font-bold hover:bg-[#E55100] transition-colors text-sm sm:text-base"
                                >
                                    Write a Review
                                </button>
                            </div>
                            ...
                            <div className="bg-gray-50 rounded-xl p-4 sm:p-6 mb-6 sm:mb-8">
                                <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
                                    <div className="text-center">
                                        <div className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900">{product.average_rating || '0.0'}</div>
                                        <div className="flex justify-center mt-2">
                                            {renderStars(product.average_rating || 0)}
                                        </div>
                                        <div className="text-gray-600 mt-1 text-sm sm:text-base">{product.review_count || 0} reviews</div>
                                    </div>
                                    <div className="flex-1">
                                        <div className="text-gray-700 font-medium mb-2 text-sm sm:text-base">Rating Breakdown</div>
                                        {[5, 4, 3, 2, 1].map((star) => (
                                            <div key={star} className="flex items-center gap-3 mb-1">
                                                <div className="text-xs sm:text-sm w-6 sm:w-8">{star}★</div>
                                                ...
                                                <div className="text-xs sm:text-sm text-gray-600 w-6 sm:w-10 text-right">
                            ...
                            {product.reviews && product.reviews.length > 0 ? (
                                        ...
                                        <div key={review.id} className="border-b pb-4 sm:pb-6 last:border-0">
                                            <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-3 sm:mb-4 gap-2">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="font-bold text-sm sm:text-base">{review.user_name || 'Anonymous'}</div>
                                                        <div className="flex text-yellow-400 mt-1">
                                                            {[...Array(5)].map((_, i) => (
                                                                <FaStar 
                                                                    key={i} 
                                                                    className={`${i < review.stars ? 'fill-current' : 'text-gray-300'} text-sm sm:text-base`}
                                                                />
                                                            ))}
                                                        </div>
                                                    </div>
                                            ...
                                            {review.image_url && (
                                                <img 
                                                    ...
                                                    alt="Review" 
                                                    className="w-24 h-24 sm:w-32 sm:h-32 object-cover rounded-lg mt-2"
                                                />
                                            )}
                                        </div>
                                    ))}
                                ...
                                <div className="text-center py-8 sm:py-12">
                                    <FaRegStar className="text-4xl sm:text-5xl text-gray-300 mx-auto mb-3 sm:mb-4" />
                                    <p className="text-gray-600 mb-3 sm:mb-4 text-sm sm:text-base">No reviews yet. Be the first to review this product!</p>
                                    <button 
                                        onClick={() => {
                                            if (!user) {
                                                toast.info("Please login to write a review!");
                                        ...
                                        className="bg-gray-100 text-gray-800 px-4 sm:px-6 py-2 rounded-lg font-bold hover:bg-gray-200 transition-colors text-sm sm:text-base"
                                    >
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 md:p-8">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                <div className="flex justify-between border-b pb-2 sm:pb-3">
                                    ...
                                    <span className="font-medium text-sm sm:text-base">{product.category_name || 'N/A'}</span>
                                </div>
                                {/* 🔥 UPDATED: Stock Display */}
                                <div className="flex justify-between border-b pb-2 sm:pb-3">
                                    <span className="text-gray-600 text-sm sm:text-base">Stock:</span>
                                    <span className={`font-medium text-sm sm:text-base ${stockLeft > 0 ? 'text-green-600' : 'text-red-600'}`}>
                                ...
                                {selectedVariant && (
                                    <>
                                        <div className="flex justify-between border-b pb-2 sm:pb-3">
                                            <span className="text-gray-600 text-sm sm:text-base">Variant SKU:</span>
                                            <span className="font-medium text-sm sm:text-base">{selectedVariant.sku}</span>
                                        </div>
                                        {selectedSize && (
                                            <div className="flex justify-between border-b pb-2 sm:pb-3">
                                                <span className="text-gray-600 text-sm sm:text-base">Size:</span>
                                                <span className="font-medium text-sm sm:text-base">{selectedSize}</span>
                                            </div>
                                        )}
                                        {selectedColor && (
                                            <div className="flex justify-between border-b pb-2 sm:pb-3">
                                                <span className="text-gray-600 text-sm sm:text-base">Color:</span>
                                                <span className="font-medium text-sm sm:text-base">{selectedColor}</span>
                                            </div>
                                        )}
                                        {selectedMaterial && (
                                            <div className="flex justify-between border-b pb-2 sm:pb-3">
                                                <span className="text-gray-600 text-sm sm:text-base">Material:</span>
                                                <span className="font-medium text-sm sm:text-base">{selectedMaterial}</span>
                                            </div>
                                        )}
                                    </>
                                )}
                                ...
                                <div className="flex justify-between border-b pb-2 sm:pb-3">
                                    <span className="text-gray-600 text-sm sm:text-base">Product ID:</span>
                                    <span className="font-medium text-sm sm:text-base">{product.id}</span>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="space-y-3 sm:space-y-4">
                                    {relatedProducts.map((related) => (
                                        <Link
                                            ...
                                            className="flex items-center gap-3 sm:gap-4 p-2 sm:p-3 rounded-xl hover:bg-gray-50 transition-colors group"
                                        >
                                            <img
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="font-medium group-hover:text-[#FF5C00] transition-colors line-clamp-2 text-xs sm:text-sm">
                                                    {related.title}
                                                </div>
                                                {/* 🔥 UPDATED: Price Display */}
                                                <div className="flex items-center gap-1 sm:gap-2 mt-1">
                                                    <div className="font-bold text-[#FF5C00] text-xs sm:text-sm">
                                                        {formatPrice(
                ...
                {/* Bottom FOMO Banner */}
                {stockLeft > 0 && (
                    <div className="mt-8 sm:mt-12 md:mt-16 bg-gradient-to-r from-[#FF5C00] to-orange-500 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 text-white text-center">
                        <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">⚠️ Don't Miss Out!</h3>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                            <button
                                onClick={handleAddToCart}
                                disabled={stockLeft === 0 || (product.has_variants && !selectedVariant)}
                                className={`bg-white text-[#FF5C00] px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-xl font-bold text-sm sm:text-base md:text-lg hover:bg-gray-100 transition-colors ${
                                    (stockLeft === 0 || (product.has_variants && !selectedVariant)) && 'opacity-70 cursor-not-allowed'
                                }`}
                            >
                                Add to Cart Now
                            ...
                            <button
                                onClick={handleBuyNow}
                                disabled={stockLeft === 0 || (product.has_variants && !selectedVariant)}
                                className={`bg-transparent border border-white text-white px-4 sm:px-6 md:px-8 py-2 sm:py-3 rounded-xl font-bold text-sm sm:text-base md:text-lg hover:bg-white/10 transition-colors ${
                                    (stockLeft === 0 || (product.has_variants && !selectedVariant)) && 'opacity-70 cursor-not-allowed'
                                }`}
                            >
                                Buy Now & Save
